  ...
  return (
    ...
    >
      ...
      <>
        ...
        <CustomPTag content="Feel free to reach out for projects, collaborations, or merely to say hello!" />
        <CustomPTag content="Currently seeking new opportunities" />
...
const CustomPTag: React.FC<{ content: string }> = ({ content }) => {
  return (
    <>
      <p className="desktop:leading-[160%] font-['Geist'] text-[#333333] font-[300] desktop:text-[1.375rem]">
        {content}
      </p>
    </>
  );
